...
| `div [-s\|-c] [-r\|-x] [--sort KEY] [name]` | Live docker TUI: container overview + resource usage; keyboard filters/sort/dig/logs/start/stop/restart |
